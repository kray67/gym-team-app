...
mixin _$PlanEditorState {
 ...
 String? get planId; String get title; String get description; bool get isPublic; int get weeks; int get sessionsPerWeek; int get avgDurationMins; String get difficulty; String get equipment; List<String> get focus; List<PlanEditorExercise> get exercises; bool get isCopy;
...
@override
int get hashCode => Object.hash(runtimeType,planId,title,description,isPublic,weeks,sessionsPerWeek,avgDurationMins,difficulty,equipment,const DeepCollectionEquality().hash(focus),const DeepCollectionEquality().hash(exercises),isCopy);

@override
String toString() {
  return 'PlanEditorState(planId: $planId, title: $title, description: $description, isPublic: $isPublic, weeks: $weeks, sessionsPerWeek: $sessionsPerWeek, avgDurationMins: $avgDurationMins, difficulty: $difficulty, equipment: $equipment, focus: $focus, exercises: $exercises, isCopy: $isCopy)';
}
...
@useResult
$Res call({
 String? planId, String title, String description, bool isPublic, int weeks, int sessionsPerWeek, int avgDurationMins, String difficulty, String equipment, List<String> focus, List<PlanEditorExercise> exercises, bool isCopy
});
...
/// Create a copy of PlanEditorState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? planId = freezed,Object? title = null,Object? description = null,Object? isPublic = null,Object? weeks = null,Object? sessionsPerWeek = null,Object? avgDurationMins = null,Object? difficulty = null,Object? equipment = null,Object? focus = null,Object? exercises = null,Object? isCopy = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? planId,  String title,  String description,  bool isPublic,  int weeks,  int sessionsPerWeek,  int avgDurationMins,  String difficulty,  String equipment,  List<String> focus,  List<PlanEditorExercise> exercises,  bool isCopy)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PlanEditorState() when $default != null:
return $default(_that.planId,_that.title,_that.description,_that.isPublic,_that.weeks,_that.sessionsPerWeek,_that.avgDurationMins,_that.difficulty,_that.equipment,_that.focus,_that.exercises,_that.isCopy);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? planId,  String title,  String description,  bool isPublic,  int weeks,  int sessionsPerWeek,  int avgDurationMins,  String difficulty,  String equipment,  List<String> focus,  List<PlanEditorExercise> exercises,  bool isCopy)  $default,) {final _that = this;
switch (_that) {
case _PlanEditorState():
return $default(_that.planId,_that.title,_that.description,_that.isPublic,_that.weeks,_that.sessionsPerWeek,_that.avgDurationMins,_that.difficulty,_that.equipment,_that.focus,_that.exercises,_that.isCopy);case _:
  throw StateError('Unexpected subclass');
...
class _PlanEditorState implements PlanEditorState {
  const _PlanEditorState({this.planId, this.title = '', this.description = '', this.isPublic = false, this.weeks = 4, this.sessionsPerWeek = 3, this.avgDurationMins = 60, this.difficulty = 'intermediate', this.equipment = 'commercial_gym', final  List<String> focus = const [], final  List<PlanEditorExercise> exercises = const [], this.isCopy = false}): _focus = focus,_exercises = exercises;
...
@override@JsonKey() List<String> get focus {
...
@override
int get hashCode => Object.hash(runtimeType,planId,title,description,isPublic,weeks,sessionsPerWeek,avgDurationMins,difficulty,equipment,const DeepCollectionEquality().hash(_focus),const DeepCollectionEquality().hash(_exercises),isCopy);
...
/// Create a copy of PlanEditorState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? planId = freezed,Object? title = null,Object? description = null,Object? isPublic = null,Object? weeks = null,Object? sessionsPerWeek = null,Object? avgDurationMins = null,Object? difficulty = null,Object? equipment = null,Object? focus = null,Object? exercises = null,Object? isCopy = null,}) {
